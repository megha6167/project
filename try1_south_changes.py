...
considering map of south india by using data provided in ascii format with spaces as delimiter
"""
...
#attributes
root_grp.description = "a netCDF4 file containing information about the daily rainfall pattern of south india of year" + year()
...
# PLOTTING THE DATA ON THE MAP
    ...
    #to draw longitudes
    map.drawmeridians(np.arange(72.0,84.5,2),color='#414141',labels=[0,0,0,1],linewidth=0.5)
    #to draw latitudes
    map.drawparallels(np.arange(6.5,15.75,2),color='#414141',labels=[1,0,0,0],linewidth = 0.5)
